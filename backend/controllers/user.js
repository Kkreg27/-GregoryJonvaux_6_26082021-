...
exports.signup = (req, res, next) => {
  ...
  bcrypt
    .hash(req.body.password, 10) // Hashage 10 fois du mot de passe du corps de la requete
    .then((hash) => {
...
exports.login = (req, res, next) => {
  User.findOne({ email: req.body.email }) //permet de trouver l'utilisateur de la base de donnée depuis l'email de la requete
    .then((user) => {
      if (!user) {
